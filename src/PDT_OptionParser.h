...
#ifndef __PDT_OPTIONPARSER_H__
#define __PDT_OPTIONPARSER_H__
...
public:
	...
	void add_key(const string _k, const string _expl);
	bool exists_key(const string _k);
	string get_expl(const string _k);
