...
#ifndef __PDT_GRAINBOUNDARYRECON_H__
#define __PDT_GRAINBOUNDARYRECON_H__

//MK::implements functionality which, based on a voxel grid with grainIDs (gids) assigned to each voxel,
//allows to extract the boundary of (##MK so far only) the (central) target grain
//the boundary is extracted by marching methods

#include "PDT_GrainVoxelizer.h"
//##MK::includes
