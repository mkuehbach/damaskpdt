...
#ifndef __PDT_VERSION_H__
#define __PDT_VERSION_H__

#include "PDT_STL.h"
#include "PDT_Abinitio.h"
#include "PDT_SIUnits.h"
#include "PDT_Parallelization.h"
#include "PDT_Numerics.h"
#include "PDT_BoostSIMD.h"
...
//if not otherwise specified all properties read in SI units, all angles internally in radiants, degree in user I/O
