...
#ifndef __PDT_GRAINVOXELIZER_H__
#define __PDT_GRAINVOXELIZER_H__

//MK::functionality to generate a voxelization of integration point 
//(ip; both unique ips (uip) and periodic images of unique ips (perip)  cloud region of interest (ROI)
//provided a assignment of grainid to each ip this allows to assign each voxel a grainid: specifically
//by making the assumption that a voxel has the same grainID (gid) of the ip that is closest measuring
//the distance between the ip location and the center of the cubic voxel
